    ...
    void getUserInfoSuccessTest() {
        ...
        step("Check response 200", () -> {
            if (userNumber == 1) {
                ...
                assertEquals(user1FirstName, userInfo.getData().getFirstName());
                assertEquals(user1LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user2FirstName, userInfo.getData().getFirstName());
                assertEquals(user2LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user3FirstName, userInfo.getData().getFirstName());
                assertEquals(user3LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user4FirstName, userInfo.getData().getFirstName());
                assertEquals(user4LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user5FirstName, userInfo.getData().getFirstName());
                assertEquals(user5LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user6FirstName, userInfo.getData().getFirstName());
                assertEquals(user6LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user7FirstName, userInfo.getData().getFirstName());
                assertEquals(user7LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user8FirstName, userInfo.getData().getFirstName());
                assertEquals(user8LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user9FirstName, userInfo.getData().getFirstName());
                assertEquals(user9LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user10FirstName, userInfo.getData().getFirstName());
                assertEquals(user10LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user11FirstName, userInfo.getData().getFirstName());
                assertEquals(user11LastName, userInfo.getData().getLastName());
                ...
                assertEquals(user12FirstName, userInfo.getData().getFirstName());
                assertEquals(user12LastName, userInfo.getData().getLastName());
    ...
    void getResourceInfoSuccessTest() {
        ...
        step("Check response 200", () -> {
            if (resourceNumber == 1) {
                ...
                assertEquals(resource1PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource2PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource3PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource4PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource5PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource6PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource7PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource8PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource9PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource10PantoneValue, resourceInfo.getData().getPantoneValue());
                ...
                assertEquals(resource11PantoneValue, resourceInfo.getData().getPantoneValue());
            } else {
                ...
                assertEquals(resource12PantoneValue, resourceInfo.getData().getPantoneValue());
            }
